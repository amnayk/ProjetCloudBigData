...
response = [status for status in response if status["PreviousState"]
            ["Name"] != status["CurrentState"]["Name"]]
for status in response:
    print(status["InstanceId"] + " : " + status["PreviousState"]["Name"] + " -> " + status["CurrentState"]
          ["Name"])
